...
public class CompositeApiMavenConstants {
	...
	//=======================================================
	/*public static final String WSO2_EXECUTIONPLAN_VERSION = "1.0.0";
	public static final String WSO2_STREAM_VERSION = "1.0.0";
