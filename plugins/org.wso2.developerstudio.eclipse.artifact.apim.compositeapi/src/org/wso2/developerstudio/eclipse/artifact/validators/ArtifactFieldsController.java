...
public class ArtifactFieldsController extends AbstractFieldController {
	...
	public void validate(String modelProperty, Object value,
		...
		if(modelProperty.equals("artifactClass.name")){
			CommonFieldValidator.validateJavaClassNameField(value);
		} else if (modelProperty.equals("artifactClass.package.name")) {
